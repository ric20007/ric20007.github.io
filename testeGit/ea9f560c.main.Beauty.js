...
(function() {
    ...
    r = function(e, t) {
        ...
        function() {
            ...
            O = $("<tr class='color" + i + "'><td>" + e + "<td>" + A + "<td>" + L + "</tr>"), r != null && (O.addClass("clash"), k.children().eq(r).addClass("clash"), s++), d === h.length ? k.append(O) : k.children().eq(d).before(O), h.splice(d, 0, {
                code: e,
                title: A,
                time: L,
                key: g,
